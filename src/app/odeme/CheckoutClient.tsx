...
export function CheckoutClient() {
  ...
  const { cart, totalPrice, clearCart, shippingCost } = useCart()
  ...
  // Kargo ücreti admin panelindeki mağaza ayarlarından (CartContext üzerinden) geliyor,
      ...
      {paytrIframeUrl ? (
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10">
          ...
          <div className="lg:col-span-5">
            <div className="bg-white rounded-3xl p-6 sm:p-8 border border-slate-200 shadow-sm space-y-6 lg:sticky lg:top-24">
              ...
              >
                {isLoading ? (
                  ...
                  <>
                    ...
                    <span>{formatPrice(grandTotal)} · Güvenli Ödemeye Geç</span>
                  </>
                )}
              </button>
